...
appendix_world_plot <- 
    tm_shape(world_border) +
        ...
        tm_layout(legend.position = c("left", "bottom"), legend.bg.color = "white", legend.title.size = 1.5, legend.text.size = 1.4)
