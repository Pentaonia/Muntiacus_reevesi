...
owncount(col_result, "VIF", 10, "max") %>%
    ...
    xtable(.,
    caption = "Collinearity statistics of the used predictors. VIF = $\\frac{1}{R²}$ = Variance inflation factor. Sorted after VIF. Mean prec. = Annual mean precipitation, Mean temp. = Annual mean temperature, Count = Count of significant corellated variables + Intercept"
) %>%
...
print(file = "./4_output/Plots and tables/EU_Test_Statistics.tex", caption.placement = getOption("xtable.caption.placement", "top"))
```
