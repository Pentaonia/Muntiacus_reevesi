...
legend("topleft", legend = "B) Standard deviation\n     of A", cex = 2, box.lty = 0, bg = NA, inset = inset)
...
legend("topleft", legend = "D) Standard deviation\n     of C", cex = 2, box.lty = 0, bg = NA, inset = inset)
}
...
mat <- matrix(
    ...
    nrow = 2, 
    byrow = T)
layout(mat, widths = c(1,1,1), heights = c(1, 0.2))
...
mapsf::mf_map(AOI, var = "point_aoi_inter", type = "choro", pal = colorRampPalette(my_col)(8), breaks = "q6")

plot(AOI["point_aoi_inter"], nbreaks = 5, breaks = "quantile", pal = colorRampPalette(my_col)(5), reset = F)
